...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <p>Registrar, por estudiante o grupos de estudiantes, los apoyos específicos o actividades especiales que
                se realizan en
                forma individual o en pequeños grupos dentro o fuera del aula regular y el o las/os nombres de los
                profesionales que
                los entregan</p>
        </div>
        <!-- /.col-lg-12 -->
    ...
    <div class="row">
        <form id="" role="form" method="POST" action="../modulos/insertar_objetivos.php">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="txt_actividades" id="txt_actividades" rows="3" class="form-control"
                                        maxlength="130" placeholder="Hasta 130 caracteres..."></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Observaciones / Acuerdos</label>
                                    <textarea name="txt_observaciones" id="txt_observaciones" rows="3" class="form-control"
                                        maxlength="130" placeholder="Hasta 130 caracteres..."></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="insertar_objetivos" id="insertar_objetivos" value="Insertar a planilla"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <a href="agregar_resumen.php?id=<?php echo $id_planilla; ?>" type="submit" name="btn-ver"
                                        class="btn btn-success btn-lg btn-block">Agregar Resumen</a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <a href="editar_resumen.php?id=<?php echo $id_planilla; ?>" type="submit" name="btn-editar"
                                        class="btn btn-warning btn-lg btn-block">Editar Resumen</a>
                                </div>
                            </div>
                        </div>
                    </div>
